...
void set_outPuts(void)
{
    ...
    wiced_hal_gpio_configure_pin( LED_GPIO_09, GPIO_OUTPUT_ENABLE, GPIO_PIN_OUTPUT_LOW);
	...
	wiced_hal_gpio_configure_pin(PORT_INT_02, ( GPIO_INPUT_ENABLE | GPIO_PULL_UP_DOWN_NONE | GPIO_EN_INT_FALLING_EDGE ), GPIO_PIN_OUTPUT_HIGH );
	...
	//wiced_hal_gpio_register_pin_for_interrupt( PORT_INT_02, button_cback_26, 0 );
}
